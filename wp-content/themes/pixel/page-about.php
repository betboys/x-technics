            ...
            if ($featured_posts) : ?>
                <ul class="about-cards-container">
                    ...
                    <?php if (get_field('service_link')) : ?>
                        <li class="about-card-list">
                            <img class="about-card-img" src="<?php echo get_template_directory_uri(); ?>/images/Subtract-style.png" alt="">
                            <div class="text-link">
