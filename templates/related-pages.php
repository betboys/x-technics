				...
				<div class="swiper-slide swiper-slide-margin-rigth">
					<a class="service-single-link" href="<?php echo get_permalink(); ?>">
						<div class="slide-single-img-inner">
							<img class="slide-image slide-image-size single-slide-photo" src="<?= $featured_image_url ?>"
								alt="">
						</div>
	...
	<div class="next-prev-buuton">
		...
		<button class="swiper-button-next">
			...
			<svg class="next-mob" xmlns="http://www.w3.org/2000/svg" width="124" height="56" viewBox="0 0 124 56"
				fill="none">
				<path class="arrow-path" d="M92.5 1L123 37.5V55H31.5L1 18.5V0.999996L92.5 1Z"
					stroke="url(#paint0_linear_2038_96793)" stroke-width="1.5" />
				<defs>
